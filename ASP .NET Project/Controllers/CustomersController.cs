...
namespace ASP.NET_Project.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Fullname,Email,Phone,Password,ConfirmPassword,Age,Gender,Status")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Fullname,Email,Phone,Password,ConfirmPassword,Age,Gender,Status")] Customer customer)
        {
            if (!ModelState.IsValid) return View(customer);
