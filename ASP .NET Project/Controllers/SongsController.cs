...
namespace ASP.NET_Project.Controllers
{
    ...
    public class SongsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetSong(long id)
        {
        ...
        public async Task<IHttpActionResult> PutSong(long id, Song song)
        {
        ...
        // DELETE: api/Songs/5
        [ResponseType(typeof(Song))]
        public async Task<IHttpActionResult> DeleteSong(long id)
        {
            Song song = await db.Songs.FindAsync(id);
            if (song == null)
            {
